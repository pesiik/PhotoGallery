...
public class PollService extends IntentService {
    ...
    public static final String ACTION_SHOW_NOTIFICATION = "package com.bignerdranch.android.photogallery.SHOW_NOTIFICATION";
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if(!isNetworkAvalibaleAndConnected()){
            return;
        }
    ...
    private boolean isNetworkAvalibaleAndConnected(){
        ConnectivityManager cm = (ConnectivityManager) getSystemService(CONNECTIVITY_SERVICE);
        boolean isNetworkAvalible = cm.getActiveNetworkInfo() != null;
        boolean isNetworkConnected = isNetworkAvalible && cm.getActiveNetworkInfo().isConnected();
